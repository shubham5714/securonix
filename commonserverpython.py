CONSTANT_PACK_VERSION = '1.41.47'
demisto.debug('pack id = Base, pack version = 1.41.47')
...
### GENERATED CODE ###: from DemistoClassApiModule import *
# This code was inserted in place of an API module.
register_module_line('DemistoClassApiModule', 'start', __line__(), wrapper=-3)
...
register_module_line('DemistoClassApiModule', 'end', __line__(), wrapper=1)
### END GENERATED CODE ###  # type:ignore [no-redef]  # noqa:E402
